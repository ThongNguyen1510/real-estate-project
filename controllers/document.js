...
// Upload tài liệu - Kết hợp middleware upload và xử lý request
const uploadDocument = (req, res) => {
    try {
        ...
        const documentData = {
            ...
            file_url: req.file.path, // Changed from file_path to file_url
...
const downloadDocument = async (req, res) => {
    try {
        ...
        res.download(document.file_url, path.basename(document.file_url));
    } catch (error) {
